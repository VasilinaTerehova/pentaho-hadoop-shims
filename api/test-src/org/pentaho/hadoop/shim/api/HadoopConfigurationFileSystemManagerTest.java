...
//    assertEquals( provider, fsm.getActiveFileProvider( scheme ) );
  ...
  public void getActiveFileProvider_multipleProviders() throws Exception {
    String scheme = "scheme";
    DefaultFileSystemManager def = new DefaultFileSystemManager();
//    HadoopConfiguration config1 =
//      new HadoopConfiguration( VFS.getManager().resolveFile( "ram:///" ), "1", "one", new MockHadoopShim() );
//    HadoopConfiguration config2 =
//      new HadoopConfiguration( VFS.getManager().resolveFile( "ram:///" ), "2", "two", new MockHadoopShim() );

...
package org.pentaho.pass.hbase.shim.common;
...
import org.pentaho.pass.hbase.factory.HBaseAdmin;
import org.pentaho.pass.hbase.factory.HBaseClientFactory;
import org.pentaho.pass.hbase.factory.HBaseClientFactoryLocator;
import org.pentaho.pass.hbase.factory.HBasePut;
import org.pentaho.pass.hbase.factory.HBaseTable;
...
public class CommonHBaseConnection extends HBaseConnection {
  ...
  public void configureConnection( Properties connProps, List<String> logMessages ) throws Exception {
    ...
    try {
      ...
      log.logError(m_admin.listTables() + "");
    } finally {
  ...
  public Class<?> getDeserializedNumericComparatorClass() throws ClassNotFoundException {
    return Class.forName( "DeserializedNumericComparator" );
  }
  ...
  public Class<?> getDeserializedBooleanComparatorClass() throws ClassNotFoundException {
    return Class.forName( "DeserializedBooleanComparator" );
  }
